...
class ProyectoController extends Controller
{
    ...
    {
        // Obtener el proyecto con id_proyecto igual a 1
        
        $proyecto = Proyecto::where('id_proyecto', 1)->first();
    
        // Pasar los detalles del proyecto a la vista
        return view('project_details', compact('proyecto'));
    }
