...
<body>
    ...
    <div id="modal" class="fixed inset-0 flex items-center justify-center z-10 hidden">
        ...
        <div class="bg-white p-8 rounded-lg z-20 modal-container w-96"> <!-- Ajuste del ancho del modal -->
            ...
            <h2 class="text-lg font-bold mb-4">Nuevo Presidente</h2>
            <form action="{{url('CrudPresidenteDeAdmin')}}" method="POST"  class="mt-5 p-5 border border-gray-200 rounded-lg bg-gray-100">
