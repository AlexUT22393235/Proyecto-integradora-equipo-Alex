    ...
    <nav style="background-color: #325b87;">
        <div class="flex items-center justify-between p-6">
            <div class="flex items-center space-x-8">
                <a href="/">
                    <img src="https://github.com/AlexUT22393235/Proyecto-integradora-equipo-Alex/blob/integracion/public/images/logo.png?raw=true" alt="Logo" class="w-auto h-9 max-w-32">
                </a>
                <div class="font-semibold space-x-9 flex items-center ml-6">
                    <a href="Direccion">
                        <button class="text-white">Dashboard</button>
                    </a>
                    <a href="docsDireccion">
                        <button class="text-white">Control de Documentos</button>
                    </a>
                    <a href="controlLibros">
                        <button class="text-white">Control de Libros</button>
                    </a>
                </div>
            </div>
